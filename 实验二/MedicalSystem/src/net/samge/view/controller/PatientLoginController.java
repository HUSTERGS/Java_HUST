...
import net.samge.dbController.PatientController;
    ...
    void initialize() {
        ...
        LoginButton.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                if (checkReady()) {
                    ...
                    Patient patient = PatientController.Login(pid.getText(), password.getText());
                    if (patient != null) {
                        // 登录成功
                        try {

                            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("../fxml/PatientRegister.fxml"));
                            Parent root = fxmlLoader.load();
                            PatientRegisterController prc = fxmlLoader.getController();
                            prc.setCurrentUser(patient);
                            PatientController.updateLoginTime(patient);
        ...
        pid.textProperty().addListener(new ChangeListener<String>() {
            ...
            public void changed(ObservableValue<? extends String> observableValue, String oldValue, String newValue) {
                if (newValue.equals("")) {
                    usernamePrompt.setText("患者编号不能为空");
                } else {
                    usernamePrompt.setText("");
                }
            }
